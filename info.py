...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001813657151') # request channel id ( make sure bot is admin )
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1001813657151'))
